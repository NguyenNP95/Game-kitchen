...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      hintCounter: "Counter",
      zoneFridge: "Fridge",
      zoneFridgeHint: "Meat, produce & dairy",
      zoneJar: "Dry storage",
      zoneJarHint: "Grains & dry legumes",
      zoneTrash: "Trash",
      ...
      // Tip-bar
      tipFridge: "Meat / produce / dairy → Fridge",
      tipJar: "Grains & legumes → Dry storage",
    ...
    vi: {
      ...
      hintCounter: "Bàn bếp",
      zoneFridge: "Tủ lạnh",
      zoneFridgeHint: "Thịt, rau củ & sữa",
      zoneJar: "Đồ khô",
      zoneJarHint: "Ngũ cốc & đậu khô",
      zoneTrash: "Thùng rác",
      ...
      tipFridge: "Thịt / rau củ / sữa → Tủ lạnh",
      tipJar: "Ngũ cốc & đậu → Đồ khô",
